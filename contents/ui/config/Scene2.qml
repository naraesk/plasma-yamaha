...
Item {
    property alias cfg_s2_title: title.text
    property alias cfg_s2_fl_vol: fl_vol.value
    property alias cfg_s2_fl_dist: fl_dist.value
    property alias cfg_s2_fl_size: fl_size.currentIndex
    property alias cfg_s2_fr_vol: fr_vol.value
    property alias cfg_s2_fr_dist: fr_dist.value
    property alias cfg_s2_fr_size: fr_size.currentIndex
    property alias cfg_s2_center_vol: center_vol.value
    property alias cfg_s2_center_dist: center_dist.value
    property alias cfg_s2_center_size: center_size.currentIndex
    property alias cfg_s2_sl_vol: sl_vol.value
    property alias cfg_s2_sl_dist: sl_dist.value
    property alias cfg_s2_sl_size: sl_size.currentIndex
    property alias cfg_s2_sr_vol: sr_vol.value
    property alias cfg_s2_sr_dist: sr_dist.value
    property alias cfg_s2_sr_size: sr_size.currentIndex
    property alias cfg_s2_sbl_vol: sbl_vol.value
    property alias cfg_s2_sbl_dist: sbl_dist.value
    property alias cfg_s2_sbl_size: sbl_size.currentIndex
    property alias cfg_s2_sbr_vol: sbr_vol.value
    property alias cfg_s2_sbr_dist: sbr_dist.value
    property alias cfg_s2_sbr_size: sbr_size.currentIndex
    property alias cfg_s2_fpl_vol: fpl_vol.value
    property alias cfg_s2_fpl_dist: fpl_dist.value
    property alias cfg_s2_fpl_size: fpl_size.currentIndex
    property alias cfg_s2_fpr_vol: fpr_vol.value
    property alias cfg_s2_fpr_dist: fpr_dist.value
    property alias cfg_s2_fpr_size: fpr_size.currentIndex
    property alias cfg_s2_rpl_vol: rpl_vol.value
    property alias cfg_s2_rpl_dist: rpl_dist.value
    property alias cfg_s2_rpl_size: rpl_size.currentIndex
    property alias cfg_s2_rpr_vol: rpr_vol.value
    property alias cfg_s2_rpr_dist: rpr_dist.value
    property alias cfg_s2_rpr_size: rpr_size.currentIndex
    property alias cfg_s2_subwoofer_vol: subwoofer_vol.value
    property alias cfg_s2_subwoofer_dist: subwoofer_dist.value
    property alias cfg_s2_subwoofer_size: subwoofer_size.currentIndex
    property alias cfg_s2_subwoofer2_vol: subwoofer2_vol.value
    property alias cfg_s2_subwoofer2_dist: subwoofer2_dist.value
    property alias cfg_s2_subwoofer2_size: subwoofer2_size.currentIndex
